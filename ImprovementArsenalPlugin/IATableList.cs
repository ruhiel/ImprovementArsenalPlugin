namespace ImprovementArsenalPlugin
{
	public partial class IATable
	{
		public static IATable[] List = new IATable[] {
			...
			new IATable { Equip = "F4F-3", Days = new string[] {"日","水","木","金","土"}, ShipName = "Saratoga"},
			...
			new IATable { Equip = "試製景雲(艦偵型)", Days = new string[] {"日","金","土"}, ShipName = "翔鶴改二甲"},
			new IATable { Equip = "試製景雲(艦偵型)", Days = new string[] {"日","月","火"}, ShipName = "瑞鶴改二甲"},
			...
			new IATable { Equip = "25mm三連装機銃 集中配備", Days = new string[] {"木","金","土"}, ShipName = "摩耶改二"},
			new IATable { Equip = "25mm三連装機銃 集中配備", Days = new string[] {"日","金","土"}, ShipName = "鬼怒改二"},
			...
			new IATable { Equip = "特大発動艇", Days = new string[] {"日","月","金","土"}, ShipName = "鬼怒改二"},
			new IATable { Equip = "特大発動艇", Days = new string[] {"火","水","木"}, ShipName = "あきつ丸"},
